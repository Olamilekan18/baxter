  ...
  const trendingDiscussions = [
    {
      ...
      author: "@TradeMaster",
      content: "Baxter's AI predicted a 12% move post-earnings—what's your play?",
      upvotes: 1200,
      comments: 342,
      isHot: true
    },
    {
      ...
      author: "@MacroTrader",
      content: "Baxter's sentiment analysis shows 78% bearish signals on tech stocks.",
      upvotes: 890,
      comments: 210,
      isAlert: true
    },
    {
      ...
      author: "@BaxterTeam",
      content: "Automatically mirror top traders' moves with Baxter's AI Copilot!",
      upvotes: 2500,
      comments: 512,
      isNew: true
    }
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
            {[
              ...
              <div key={index} className="bg-primary p-4 rounded-lg shadow-md border-l-4 border-accent">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-primary mb-6">Trending Market Discussions</h2>
        ...
        <section className="bg-primary text-white p-8 rounded-lg mb-12">
          ...
          <div className="flex flex-wrap gap-2 mb-4">
            {["#BaxterAI", "#StocksToWatch", "#AITrading", "#EarningsSeason"].map(tag => (
              <span key={tag} className="bg-accent px-3 py-1 rounded-full text-sm">{tag}</span>
            ))}
          </div>
          <div className="space-y-3">
            <p className="italic">"Just used Baxter's AI scanner to find a 15% gap play—worked like magic!" – @DayTraderDan</p>
            <p className="italic">"Who else is riding the NVDA wave? Baxter's alerts saved me from a bad short!" – @OptionsGuru</p>
          </div>
        </section>

        <section className="text-center">
          <h2 className="text-3xl font-bold text-primary mb-4">🚀 Why Join Baxter's Community?</h2>
