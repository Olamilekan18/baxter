        ...
        <div className="rounded-2xl p-2 bg-transparent opacity-80">
          <div className="grid grid-cols-3 items-center my-2 py-1">
            <div className="p-1 md:p-2 col-span-1 grid justify-self-center">
              <img
                src={
                  "https://cdn.brandfetch.io/apple.com/w/200/h/244/theme/light/logo?c=1id090JVq9Slhwrn5Rm"
                }
                alt={"Apple Logo"}
                className="rounded-full p-2 max-h-[3.5rem]"
              />
            </div>
            <div className="grid col-span-2">
              <Link
                className="font-bold sm:max-lg:text-xl lg:text-2xl"
                href="/stock/AAPL"
              >
                Apple Inc.
              </Link>
          ...
          <div className="grid grid-cols-3 items-center my-2 py-1">
            <div className="p-1 md:p-2 col-span-1 grid justify-self-center">
              <img
                src={
                  "https://cdn.brandfetch.io/reddit.com/w/400/h/400?c=1id090JVq9Slhwrn5Rm"
                }
                alt={"Reddit Logo"}
                className="rounded-full p-2 max-h-[3.5rem]"
              />
          ...
          <div className="grid grid-cols-3 items-center my-2 py-1">
            <div className="p-1 md:p-2 col-span-1 grid justify-self-center">
              <img
                src={
                  "https://cdn.brandfetch.io/coinbase.com/w/400/h/400?c=1id090JVq9Slhwrn5Rm"
                }
                alt={"Coinbase Logo"}
                className="rounded-full p-2 max-h-[3.5rem]"
              />
          ...
          <div className="grid grid-cols-3 items-center my-2 py-1">
            <div className="p-1 md:p-2 col-span-1 grid justify-self-center">
              <img
                src={
                  "https://cdn.brandfetch.io/nvidia.com/w/400/h/400?c=1id090JVq9Slhwrn5Rm"
                }
                alt={"Nvidia Logo"}
                className="rounded-full p-2 max-h-[3.5rem]"
              />
            ...
            <div className="grid col-span-2">
              ...
              <p className="sm:max-lg:text-lg lg:text-xl">
