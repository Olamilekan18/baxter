  ...
  const courseData = [
   {
    ...
    {
      "title": "How to Invest In Nigerian Stock Market and Earn Passive Income ",
      "youtubeurl": "https://youtu.be/xyuDYPvOyYk?si=wjug0H9XfF98NOBt",
      "content" : "How to Invest In Nigerian Stock Market and Earn Passive Income "
    },
    {
    ...
    ...course,
    id: course.title.toLowerCase().replace(/[^a-z0-9]+/g, '-').replace(/(^-|-$)/g, '')
  }));
