...
<p className="side_p">Visualize stock performance with dynamic, interactive charts that are easy to customize and understand. Spot trends, compare stocks, and track historical data all in one place. </p>

<p className="head_p">Comprehensive Market Data</p>

<p className="side_p">Stay ahead of the market with up-to-the-minute data, including stock prices, volume, earnings, and more. Baxter equips you with all the information you need to seize opportunities. </p>

<p className="head_p">Guided Investments</p>

<p className="side_p">Not sure where to start? Our guided investment tools offer personalized insights and curated stock recommendations based on your goals and risk tolerance.,</p>

<p className="head_p">Expert Resources</p>

<p className="side_p">Access a wealth of knowledge through our tutorials, webinars, and articles created by seasoned investors and market analysts. </p>
          </div>
        </div>
    ...
    <section className="my-2 md:my-4 p-2 md:p-4" id="offerings">
      ...
      <div>
        <p className="head_p">Customisable Dashboards</p>
          <p className="side_p">Tailor your experience by adding the charts and data points that matter to you!</p>

        <p className="head_p">Smart Alerts</p>
        <p className="side_p">
          Get real-time, up-to-date notifications on stock prices, index funds and so much more
        </p>
        ...
        <p className="side_p">
          Access Baxter on the go and on the job with our responsive design and mobile-friendly architecture. 
        </p>
